...
<div class="page-header position-relative">
    <ul class="pagination" style="padding: 15px;margin-top: 0px;position:absolute;left: 40%">
        ...
        <li class="<?php if($currentPage===$index) echo 'active';?>"><a href="<?php echo site_url('home_controller/index');?>?page=<?php echo $index;?>"><?php echo $index;?></a></li>
        <?php } ?>
        <li class="<?php if($currentPage===$pageCount) echo 'active';?>"><a href="<?php echo site_url('home_controller/index');?>?page=<?php echo $pageCount;?>">&raquo;</a></li>
    </ul>
</div>
