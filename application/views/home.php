...
<div class="article" href="<?php echo site_url('article_controller/detail')?>">
    <div class="articletitle">
        ...
        <h2><p style="font-size: 13px;position: absolute;right: 30%;top: 45px">作者：<?php echo $row->createuser;?></p>
            <p style="font-size: 13px;position: absolute;right: 2%;top: 45px">时间：<?php echo $row->createtime.'<br>';?></p></h2>
